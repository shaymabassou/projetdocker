    ...
    >
      <div className="h-full flex flex-col justify-center px-5 pb-4 overflow-y-auto">
        <div className="flex items-center py-4">
          <Image src="/images/img.png" alt="Veterinary Logo" className="w-10 h-10 mr-3" />
          ...
          <Disclosure as="div">
            {({ open }) => (
              <>
                ...
                <Disclosure.Panel className="pl-4 space-y-2">
                  <NavItem href="/listeordonnance" icon={<AiOutlineFileText />} label="Liste Des Ordonnances" />
                </Disclosure.Panel>
              </>
            )}
          </Disclosure>
          <Disclosure as="div">
            {({ open }) => (
              <>
                ...
                <Disclosure.Panel className="pl-4 space-y-2">
                  <NavItem href="/addfacturation" icon={<RiBillLine />} label="Factures" />
                </Disclosure.Panel>
              </>
            )}
          </Disclosure>
